...
public class Connection implements PeerConnection.Observer, DataChannel.Observer, BandwidthLimiter.OnBandwidthFree {
    ...
    public void makeConnection() {
        String uri = "stun:stun.l.google.com:19302";
    ...
    public void onOffer(JSONObject offer) {
        ...
        String sdp = null;
        try {
            sendChunk = "chrome".equals(offer.getString("browser").toLowerCase());
    ...
    public void onAddStream(MediaStream mediaStream) {
        System.out.println("==============TAOCAMMEDIASTREM" + mediaStream.getId());
    }
